...
(function($, window, document, undefined) {
    ...
    var defaults = {
        ...
        itemRenderer: function(item_attrs, content, children, options, item) {
            ...
            html += '<button class="dd-cog" type="button" data-toggle="modal" data-target="#modal_nestable" data-type="edit">cog</button>';
            html += '<button class="dd-delete" type="button">delete</button>';
